 ...
 * legacy binding
 **/
Operation.prototype.do = function (args, opts, callback, error, parent, reqTimeout) {
  return this.execute(args, opts, callback, error, parent, reqTimeout);
};

/**
 * executes an operation
 **/
Operation.prototype.execute = function (arg1, arg2, arg3, arg4, parent, reqTimeout) {
  var args = arg1 || {};
  ...
  var obj = {
    timeout: reqTimeout || this.timeout,
    url: url,
